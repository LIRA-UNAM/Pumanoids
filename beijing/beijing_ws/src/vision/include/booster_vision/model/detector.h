...
public:
    ...
    void setPreprocessBackend(const std::string &backend) {
        preprocess_backend_ = backend;
    }

    const std::string &getPreprocessBackend() const {
        return preprocess_backend_;
    }

    void setDecodeBackend(const std::string &backend) {
        decode_backend_ = backend;
    }

    const std::string &getDecodeBackend() const {
...
protected:
    ...
    std::string decode_backend_ = "cpu";
};
