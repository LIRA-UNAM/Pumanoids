// TensorRT version macros are supplied by vision/CMakeLists.txt.  JetPack
// 7.2 may omit NvInferVersion.h from the public include set, so do not make
// this legacy post-processing source depend on that optional header.
