...
// Format a vector with the requested precision, for example "[1.2, 3.4]".
template<typename T>
...
// Print str between horizontal borders and return the input string.
...
// Print str in a prominent red ERROR block and return the input string.
inline string prtErr(const string &str)
{
    return prettyPrint(str, "ERROR", RED_CODE);
}

// Print str in a prominent DEBUG block and return the input string.
