...
#ifdef __cplusplus
static_assert(sizeof(RobotInfo) == 3, "Unexpected GameController RobotInfo layout");
static_assert(sizeof(TeamInfo) == 70, "Unexpected GameController TeamInfo layout");
static_assert(sizeof(RoboCupGameControlData) == 158, "Unexpected GameController control packet layout");
static_assert(sizeof(RoboCupGameControlReturnData) == 32, "Unexpected GameController status packet layout");
#endif
