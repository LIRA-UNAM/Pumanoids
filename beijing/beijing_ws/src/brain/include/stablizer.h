/**
 * @file stablizer.h
 * @brief Defines a Stablizer class for smoothing noisy data.
 */
#pragma once
...
// Stablizer stores a time window of samples and smooths them to prevent jitter.
class Stablizer
{
public:
    Stablizer()
    ...
    // Return the current smoothed value. Supported methods: mean, max, and min.
