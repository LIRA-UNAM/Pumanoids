...
def generate_launch_description():
    ...
    pkg_share_path = os.pathsep + os.path.join(get_package_prefix('g1_description'), 'share')
    ...
    description_pkg_path  = get_package_share_directory('g1_description')
    urdf_file_path = os.path.join(description_pkg_path, 'urdf', 'g1_23dof_mode_10.urdf')
