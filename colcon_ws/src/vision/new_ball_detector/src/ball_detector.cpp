...
// Camera constants (from your Python code)
static constexpr double K1_hfov = 93.0;
static constexpr double K1_vfov = 101.0;
static constexpr double T1_hfov = 95.0;

static constexpr double K1_head_height = 0.87;
static constexpr double ball_radius = 0.07;
static constexpr double head_x = 0.0;
static constexpr double head_y = 0.0;
static constexpr double head_z = K1_head_height;
static constexpr double HFOV = (T1_hfov * M_PI) / 180.0;
static constexpr double VFOV = (K1_vfov * M_PI) / 180.0;
  ...
  double img_x, double img_y, int img_width, int img_height)
{
  ...
  double lambda = (ball_radius - head_z) / uz;
